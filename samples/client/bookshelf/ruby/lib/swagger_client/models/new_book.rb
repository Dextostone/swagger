...
module SwaggerClient
  class NewBook
    ...
    def self.swagger_types
      {
        :'name' => :'String',
        :'authors' => :'Array<NewAuthor>',
        :'comments' => :'Array<NewComment>',
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'publishedOn']
        self.published_on = attributes[:'publishedOn']
      end
      
      if attributes[:'isbn13']
        self.isbn13 = attributes[:'isbn13']
      end
      
      if attributes[:'isbn10']
        self.isbn10 = attributes[:'isbn10']
      end
    ...
    def hash
      [name, authors, comments, publisher, published_on, isbn13, isbn10, tags].hash
    end
