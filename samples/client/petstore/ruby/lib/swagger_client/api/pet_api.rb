...
module SwaggerClient
  class PetApi
    ...
    def find_pets_by_status(status, opts = {})
      data, status_code, headers = find_pets_by_status_with_http_info(status, opts)
      return data
    end
    ...
    def find_pets_by_tags(tags, opts = {})
      data, status_code, headers = find_pets_by_tags_with_http_info(tags, opts)
      return data
    end
    ...
    def upload_file(pet_id, opts = {})
      data, status_code, headers = upload_file_with_http_info(pet_id, opts)
      return data
    end
